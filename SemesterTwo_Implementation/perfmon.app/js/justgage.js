...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    gaugeWidthScale: kvLookup('gaugeWidthScale', config, dataset, 0.1),

    // gaugeColor : string
    // background color of gauge element
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#fff"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#403d3d"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#0bd1d7", "#02ccf9", "#06b8e8"], 'array', ','),
    ...
    donut: kvLookup('donut', config, dataset, true),
